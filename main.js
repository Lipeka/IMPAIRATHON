...
var QuestionArray = [ 
    ...
    {
        'Difficulty': 0,
        'Title': "Name the part responsible for photosynthesis",
        'Options': {
            'a': { 'text': "leaf", 'value': 1 },
            'b': { 'text': "root", 'value': 0 },
            'c': { 'text': "stem", 'value': 0 },
            'd': { 'text': "fruit", 'value': 0 },
        }
    },
    {
        'Difficulty': 1,
        'Title': "Which season comes in the month of May?",
        'Options': {
            'a': { 'text': "Winter", 'value': 0 },
            'b': { 'text': "Monsoon", 'value': 0 },
            'c': { 'text': "Summer", 'value': 1 },
            'd': { 'text': "Autumn", 'value': 0 },
        }
    },
    {
        'Difficulty': 2,
        'Title': "Which part pumps blood to the body?",
        'Options': {
            'a': { 'text': "Heart", 'value': 1 },
            'b': { 'text': "Liver", 'value': 0 },
            'c': { 'text': "Kidney", 'value': 0 },
            'd': { 'text': "Brain", 'value': 0 },
        }
    },
    {
        'Difficulty': 0,
        'Title': "Where does a camel live?",
        'Options': {
            'a': { 'text': "Desert", 'value': 1 },
            'b': { 'text': "Forest", 'value': 0 },
            'c': { 'text': "Ocean", 'value': 0 },
            'd': { 'text': "Grasslands", 'value': 0 },
        }
    },
    {
        'Difficulty': 0,
    ...
    {
        'Difficulty': 0,
        'Title': "The natural satelite of earth is ",
        'Options': {
            'a': { 'text': "Moon", 'value': 1 },
            'b': { 'text': "Star", 'value': 0 },
            'c': { 'text': "Sun", 'value': 0 },
